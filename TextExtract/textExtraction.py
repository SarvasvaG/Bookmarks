...
from collections import Counter
sp.prefer_gpu()
# Run anconda prompt as adminstrator and copy paste this:python -m spacy download en
...
class TextExtraction:
    ...
    def text_extract(self, website_url):
        _website = website_url
        _scrapTool = ScrapTool()
        _web = dict(_scrapTool.visit_url(_website))
        _text = (clean_text(_web['website_text']))
